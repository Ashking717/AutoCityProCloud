// app/autocityPro/jobs/[id]/edit/page.tsx
"use client";
      ...
      <MainLayout user={user} onLogout={handleLogout}>
        <div className="flex items-center justify-center min-h-screen bg-[#050505]">
          <div className="text-center">
            <div className="inline-block animate-spin rounded-full h-8 w-8 border-b-2 border-[#E84545] mb-3"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            <div className="md:hidden bg-[#0A0A0A] rounded-lg shadow-lg border border-white/5 p-4">
              <button
                onClick={handleSubmit}
                disabled={loading || !jobTitle.trim() || items.length === 0}
