...
import { Plus, Trash2, BookOpen, Save, Send } from 'lucide-react';
      ...
      <div className="p-8">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Record adjusting and correcting entries</p>
            </div>
          </div>
          <button
            onClick={() => router.back()}
        ...
        <div className="flex justify-end space-x-3">
          ...
          <button
            ...
            disabled={loading}
            className="flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg hover:opacity-90 disabled:opacity-50"
          >
