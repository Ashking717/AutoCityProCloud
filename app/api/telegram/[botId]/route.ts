...
export async function POST(
  ...
  try {
    ...
    console.log(`[Telegram:${botId}] intent=${intent.category}`);
    ...
    saveHistory(sessionKey, updatedHistory);
...
export async function GET(
  ...
  const webhookUrl = `${appUrl}/api/telegram/${botId}`;
