          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">{accountNumber} - {accountType}</p>
              </div>
            </div>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  {ledgerData.ledgerEntries.length > 0 && (
                    <tfoot className="bg-gray-50 font-bold">
                      <tr>
                        <td colSpan={4} className="px-6 py-4 text-sm text-right text-gray-900">
                          TOTAL
                        </td>
                        ...
                        <td className={`px-6 py-4 text-sm text-right ${
                          ledgerData.summary.closingBalance >= 0 ? 'text-green-600' : 'text-red-600'
                        }`}>
                          QAR {Math.abs(ledgerData.summary.closingBalance).toFixed(2)}
                        </td>
                      </tr>
                ...
                >
                  ...
                  <div className="space-y-2 mb-4">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium">{accountGroup}</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-600">Opening Balance:</span>
                      <span className="font-semibold">QAR {openingBalance.toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between text-sm">
